...
@Component({
  selector: 'app-rough-diamond-review',
  templateUrl: './rough-diamond-review.component.html',
  styleUrls: ['./rough-diamond-review.component.css'],
})
export class RoughDiamondReviewComponent implements OnInit {
  document: any;
  application: any;
