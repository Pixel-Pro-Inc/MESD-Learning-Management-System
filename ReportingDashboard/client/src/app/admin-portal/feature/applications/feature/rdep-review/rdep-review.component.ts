...
@Component({
  selector: 'app-rdep-review',
  templateUrl: './rdep-review.component.html',
  styleUrls: ['./rdep-review.component.css'],
})
export class RdepReviewComponent implements OnInit {
  document: any;
  application: any;
  ...
  parcelInformationReturnsColumns = [
    {
      field: 'number',
