...
class block_course_overview extends block_base {
    ...
    public function get_content() {
        ...
        $group = get_user_preferences('block_course_overview_user_grouping_preference');
        $sort = get_user_preferences('block_course_overview_user_sort_preference');
        $view = get_user_preferences('block_course_overview_user_view_preference');
        $paging = get_user_preferences('block_course_overview_user_paging_preference');
        $customfieldvalue = get_user_preferences('block_course_overview_user_grouping_customfieldvalue_preference');

        $renderable = new \block_course_overview\output\main($group, $sort, $view, $paging, $customfieldvalue);
    ...
    public function get_config_for_external() {
        ...
        $configs = get_config('block_course_overview');
