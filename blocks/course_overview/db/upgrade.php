...
/**
 * Upgrade code for the course_overview block.
 *
...
function xmldb_block_course_overview_upgrade($oldversion) {
    ...
    if ($oldversion < 2021052504) {
        upgrade_block_delete_instances('course_overview', '__default', 'my-index');
        ...
        upgrade_block_savepoint(true, 2021052504, 'course_overview', false);
    }

    if ($oldversion < 2022041901) {
        upgrade_block_set_my_user_parent_context('course_overview', '__default', 'my-index');
        upgrade_block_savepoint(true, 2022041901, 'course_overview', false);
    }
