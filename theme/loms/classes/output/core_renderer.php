...
class core_renderer extends \core_renderer {
   ...
   */
    ...
    public function get_theme_image_footer_shape_img1($maxwidth = null, $maxheight = 100) {
        global $CFG;
        if (!empty($this->page->theme->settings->footer_shape_img1)) {
            $url = $this->page->theme->setting_file_url('footer_shape_img1', 'footer_shape_img1');
            // Get a URL suitable for moodle_url.
            $relativebaseurl = preg_replace('|^https?://|i', '//', $CFG->wwwroot);
            $url = str_replace($relativebaseurl, '', $url);
            return new moodle_url($url);
            return parent::get_theme_image_footer_shape_img1($maxwidth, $maxheight);
        }
    }

    public function get_theme_image_footer_shape_img2($maxwidth = null, $maxheight = 100) {
        global $CFG;
        if (!empty($this->page->theme->settings->footer_shape_img2)) {
            $url = $this->page->theme->setting_file_url('footer_shape_img2', 'footer_shape_img2');
            // Get a URL suitable for moodle_url.
            $relativebaseurl = preg_replace('|^https?://|i', '//', $CFG->wwwroot);
            $url = str_replace($relativebaseurl, '', $url);
            return new moodle_url($url);
            return parent::get_theme_image_footer_shape_img2($maxwidth, $maxheight);
        }
    }
    ...
    public function render_lang_menu() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_loms/lang_menu', $context);
            }
        }
    }
    ...
    public function if_home_pages() {
        ...
        $hide_global_banner     = 1;//get_config('theme_loms', 'hide_global_banner');
    ...
    public function if_hide_page_bottom_content() {
        ...
        $hide_page_bottom_content      = get_config('theme_loms', 'hide_page_bottom_content');
    ...
    public function banner_bg_image() {
        $url = new moodle_url('/theme/loms/pix/img/shape8.svg');
        return $url;
    }
     ...
     * @return string
     */
    public function loms_if_user_enrolled() {
     ...
     * @return string
     */
    public function loms_enroll_link() {
        $actual_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
        $id = $_GET['id'];
        global $CFG;
     ...
     * if_guest
     */
    public function if_loms_guest() {
        $hide_guest_access_curriculum       = '';
        $hide_guest_access_curriculum       = theme_loms_get_setting('hide_guest_access_curriculum');
    ...
    public function get_pix_image_url_base() {
        ...
        return $CFG->wwwroot . "/theme/loms/pix";
    }
    ...
    public function get_footer_bottom() {
        $footer_copyright       = '';
        $footer_copyright       = theme_loms_get_setting('footer_copyright');
        ob_start();
        ?>
    ...
    public function search_box($id = false) {
        global $CFG;
        $search_placeholder = '';
        $search_placeholder = theme_loms_get_setting('search_placeholder', true);
        $wwwroot = $CFG->wwwroot;
    ...
    public function user_menu($user = null, $withlinks = null) {
        ...
        if ($withlinks) {
            ...
            foreach ($opts->navitems as $key => $value) {
                ...
                switch ($value->itemtype) {
                    ...
                    case 'link':                        
                        $loms_nav_items .= '<a class="dropdown-item" href="'. $value->url .'">'. $value->title .'</a>';
        ...
        return $loms_nav_items;
    }

    /**
     * region_main_settings_menu
     */
    public function loms_region_main_settings_menu() {
        global $OUTPUT;
