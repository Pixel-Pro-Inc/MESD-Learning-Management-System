...
include($CFG->dirroot . '/theme/loms/inc/loms_globalsearch_navbar.php');
require_once($CFG->dirroot. '/theme/loms/inc/loms_page_handler.php');

// Add block button in editing mode.
$addblockbutton = $OUTPUT->addblockbutton();

$lomsPageHandler = new lomsPageHandler();
$pageheading = $lomsPageHandler->lomsGetPageTitle();
...
$lomsUserBodyClass = 'loms_body_class';
$extraclasses = array(
    'loms_no_hero',
    $user_status,
    $lomsUserBodyClass
...
if($isloggedin){
    $lomsProfileIconUsername = $USER->firstname . ' '. $USER->lastname;
}else{
    $lomsProfileIconUsername = '';
}
...
if($favicon) {
    ...
    $favicon = $CFG->wwwroot . '/theme/loms/pix/favicon.ico';
}

if (get_config('theme_loms', 'logo_visibility') == 1) {
 ...
 * Main Logo
 */
$logo_image_width  = preg_replace("/[^0-9]/", "", get_config('theme_loms', 'logo_image_width'));
$logo_image_height = preg_replace("/[^0-9]/", "", get_config('theme_loms', 'logo_image_height'));
...
$footer_shape_img1 = $OUTPUT->get_theme_image_footer_shape_img1(null, 100);
if($footer_shape_img1) {
    $footer_shape_img1 = $OUTPUT->get_theme_image_footer_shape_img1(null, 100);
}else{
    $footer_shape_img1 = false;
}

$footer_shape_img2 = $OUTPUT->get_theme_image_footer_shape_img2(null, 100);
if($footer_shape_img2) {
    $footer_shape_img2 = $OUTPUT->get_theme_image_footer_shape_img2(null, 100);
}else{
    $footer_shape_img2 = false;
}

/**
 * Mobile Logo
 */
$mobile_logo_width  = preg_replace("/[^0-9]/", "", get_config('theme_loms', 'mobile_logo_width'));
$mobile_logo_height = preg_replace("/[^0-9]/", "", get_config('theme_loms', 'mobile_logo_height'));
 ...
 * Footer Logo
 */
if (get_config('theme_loms', 'footer_logo_visibility') == 1) {
    $footer_logo_visibility = false;
} else {
    $footer_logo_visibility = true;
}
$footer_logo_width  = preg_replace("/[^0-9]/", "", get_config('theme_loms', 'footer_logo_width'));
$footer_logo_height = preg_replace("/[^0-9]/", "", get_config('theme_loms', 'footer_logo_height'));
...
$top_header             = get_config('theme_loms', 'top_header');
$top_header_right_content = get_config('theme_loms', 'top_header_right_content');
$top_header_content     = get_config('theme_loms', 'top_header_content');
$header_search          = get_config('theme_loms', 'header_search');
$header_btn_url         = get_config('theme_loms', 'header_btn_url');
$header_left_btn_text   = get_config('theme_loms', 'header_left_btn_text');
$header_left_btn_url    = get_config('theme_loms', 'header_left_btn_url');
$header_btn_icon        = get_config('theme_loms', 'header_btn_icon_loms_icon_class');

$social_target = get_config('theme_loms', 'social_target');
if($social_target == 1) {
...
$footer_copyright      = get_config('theme_loms', 'footer_copyright');
...
$back_to_top    = get_config('theme_loms', 'back_to_top');
$hide_global_banner    = get_config('theme_loms', 'hide_global_banner');
$hide_guest_access_curriculum    = get_config('theme_loms', 'hide_guest_access_curriculum');
...
if(get_config('theme_loms', 'footer_col_1_body')){
    $footer_column_count++;
    $footer_column_1 = true;
}
if(get_config('theme_loms', 'footer_col_2_title') || get_config('theme_loms', 'footer_col_2_body')){
    $footer_column_count++;
    $footer_column_2 = true;
}
if(get_config('theme_loms', 'footer_col_3_title') || get_config('theme_loms', 'footer_col_3_body')){
    $footer_column_count++;
    $footer_column_3 = true;
}
if(get_config('theme_loms', 'footer_col_4_title') || get_config('theme_loms', 'footer_col_4_body')){
    $footer_column_count++;
    $footer_column_4 = true;
}
if(get_config('theme_loms', 'footer_col_5_title') || get_config('theme_loms', 'footer_col_5_body')){
    $footer_column_count++;
