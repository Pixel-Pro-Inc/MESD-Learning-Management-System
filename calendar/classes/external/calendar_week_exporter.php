 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class calendar_week_exporter extends exporter {
    /**
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $previousperiod = $this->get_previous_week_data();
        $nextperiod = $this->get_next_week_data();
     ...
     */
    protected function get_previous_week_data() {
        $type = $this->related['type'];
     ...
     */
    protected function get_next_week_data() {
        $type = $this->related['type'];
